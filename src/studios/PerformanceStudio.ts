...
export class PerformanceStudio implements IStudioPlugin {
    ...
    public async activate(): Promise<void> {
        ...
        const camera = CameraManager.instance.createArcRotateCamera("PerformanceCamera");
    ...
    private _buildUI(): void {
        ...
        title.textContent = "Performance Showcase";
        title.style.margin = "0 0 10px 0";

        const desc = document.createElement("p");
        desc.textContent = "Explore advanced performance features and capabilities.";
