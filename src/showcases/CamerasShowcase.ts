...
export class CamerasShowcase implements IShowcase {
    ...
    public async load(): Promise<void> {
        ...
        const camera = CameraManager.instance.createArcRotateCamera("CamerasCamera");
    ...
    private _buildUI(): void {
        ...
        title.textContent = "Cameras Showcase";
        title.style.margin = "0 0 10px 0";

        const desc = document.createElement("p");
        desc.textContent = "Explore advanced cameras features and capabilities.";
